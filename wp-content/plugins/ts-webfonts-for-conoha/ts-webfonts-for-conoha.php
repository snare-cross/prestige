...
class TypeSquare_ST {
	...
	public function load_scripts() {
		...
		wp_register_script( 'typesquare_std', "//code.typesquare.com/static/5b0e3c4aee6847bda5a036abac1e024a/typesquare.js", array( 'jquery' ), $version, false );
	...
	public function load_font_styles() {
        ...
        $style = $this->_get_font_styles( $use_font, $fonttheme, get_the_ID());
