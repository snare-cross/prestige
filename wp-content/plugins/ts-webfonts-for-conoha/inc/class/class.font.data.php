...
class TypeSquare_ST_Fonts {
	...
	public function get_fonttheme_options() {
		$default_param = array(
			'font_theme' 		=> false,
            'title_target'      => 'h1,h2,h3,.entry-title,h1 *,h2 *,h3 *,.entry-title *,.entry-content h2,.entry-content h2,.entry-content h3',
            'lead_target'       => '.entry-content h4,.entry-content h5,.entry-content h6,.entry-content h4 *,.entry-content h5 *,.entry-content h6 *',
            'text_target'       => '.entry-content *:not(h1):not(h2):not(h3):not(h4):not(h5):not(h6):not(strong):not(b)',
