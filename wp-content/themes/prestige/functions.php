...
if ( ! function_exists( 'onepress_setup' ) ) :
  ...
  function onepress_setup() {
    ...
    add_image_size( 'onepress-blog-small', 200, 150, true );
...
function onepress_scripts() {
  ...
  wp_enqueue_style( 'onepress-mailformpro', get_bloginfo('url').'/form_contact/mfp.statics/mailformpro.css' );
...
function mainte_link() {
  return '<div class="link_box"><a href="http://www.prestige-co.com/relieve_maintenance/"><p>安心の納車前整備　＞　</p></a></div>';
}
add_shortcode('mainte_link', 'mainte_link');
